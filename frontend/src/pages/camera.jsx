...
// import { Camera, WifiOff, Trash2, VideoOff, Maximize2, X } from "lucide-react";
// import AddCameraModal from "../components/camera/AddCamera";
// import { useState } from "react";
// import { useCamera } from "../context/CameraContext";
...
//     const isRtsp = cam.streamUrl?.toLowerCase().startsWith("rtsp://");

//     if (isRtsp) {
//         return (
//             <div className="flex flex-col items-center justify-center h-full gap-1.5 relative z-10 px-3 text-center">
//                 <WifiOff size={22} className="text-slate-600" />
//                 <span className="text-slate-600 text-[9px] leading-relaxed">
//                     RTSP requires a media proxy
//                 </span>
//             </div>
//         );
//     }
...
//     // Fallback
//     return (
//         <div className="flex flex-col items-center justify-center h-full gap-1.5 relative z-10">
...
//                     {isRtsp ? (
//                         <div className="flex flex-col items-center justify-center h-full gap-3 text-slate-500 absolute inset-0">
//                             <WifiOff size={36} />
//                             <p className="text-sm text-center px-8">
//                                 RTSP streams require a media proxy (e.g. MediaMTX, FFmpeg) for browser playback.
//                             </p>
//                         </div>
//                     ) : !imgError ? (
//                         <img
...
//                         >
//                             {/* Stream area */}
//                             <div className="relative h-36 bg-[#0a0c12] flex items-center justify-center overflow-hidden">
//                                 <div className="absolute inset-0 bg-gradient-to-br from-slate-900 to-[#0a0c12]" />
...
import { Camera, WifiOff, Trash2, VideoOff, Maximize2, X, LayoutGrid, Rows2, Square } from "lucide-react";
import AddCameraModal from "../components/camera/AddCamera";
import { useCamera } from "../context/CameraContext";

// ── Rotation-aware stream ─────────────────────────────────────────────────
// After rotate(270deg): actual_width → visual_height, actual_height → visual_width
// So to fill a W×H container: set actual_width=H, actual_height=W
function CameraStream({ cam }) {
    const [imgError, setImgError] = useState(false);
            ...
            {!imgError ? (
                <img
                    ...
                    style={{
                        ...
                        top: "50%",
                        left: "50%",
                        width: dims.h,   // swap: fills visual width after rotation
                        height: dims.w,   // swap: fills visual height after rotation
