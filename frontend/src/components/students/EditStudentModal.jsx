...
//     Upload, ImagePlus, AlertTriangle, CheckCircle, Pencil
// } from "lucide-react";
...
//                             <span className="text-slate-600 normal-case tracking-normal">(optional — leave to keep current)</span>
//                         </label>
//                         <div
//                             onClick={() => fileRef.current?.click()}
//                             className={`relative flex flex-col items-center justify-center gap-3 h-28 rounded-xl border-2 border-dashed cursor-pointer transition-all
//                                 ${errors.face ? "border-red-500/40 bg-red-500/5"
//                                     : preview ? "border-cyan-500/40 bg-cyan-500/5"
//                                         : "border-[#1e2535] bg-[#0a0c12] hover:border-cyan-500/30"}`}
//                         >
//                             {preview ? (
//                                 <>
//                                     <img src={preview} alt="preview" className="h-full w-full object-cover rounded-xl opacity-60" />
...
//                                     </div>
//                                     <p className="text-slate-500 text-xs">Click to upload new photo</p>
//                                 </>
//                             )}
//                         </div>
//                         <input ref={fileRef} type="file" accept="image/jpeg,image/png,image/jpg" onChange={handleFile} className="hidden" />
//                         {errors.face && <p className="text-red-400 text-[10px] flex items-center gap-1"><AlertTriangle size={9} />{errors.face}</p>}
//                     </div>
